...
package org.firefly.model.transport.protocol;
...
public class JProtocolHeader {
    ...
    /** Magic
     * e×16º + b×16¹ + a×16² + b×16³
     * 14×16º + 11×16¹ +1 0×16² + 11×16³
     * 14+176+2560+45056=47806
     * */
    ...
    // 相当于“编码”：消息标志位, 低地址4位messageCode用来表示消息类型request/response/heartbeat等, 高地址4位serializerCode用来表示序列化类型，左高右低。
